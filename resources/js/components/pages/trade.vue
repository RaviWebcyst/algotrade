            ...
            <div class="col-md-4 p-0">
                <main class="flex-shrink-0 main-content">
                    ...
                    <div class="d-flex gap-2 mt-4 mb-2 mx-4">
                        ...
                        <button class="btn btn-danger w-50 py-3 fw-medium fs-6" data-bs-toggle="offcanvas" data-bs-target="#offcanvasBottom" aria-controls="offcanvasBottom">
                            PUT
                        </button>
                    </div>
                </main>
                <div class="offcanvas offcanvas-bottom h-50" tabindex="-1" id="offcanvasBottom"
                    ...
                    <div class="offcanvas-body small">
                        ...
                        <div class="d-grid">
                            <button class="btn btn-main p-3 mt-2">Confirm</button>
                        </div>
                    </div>
                </div>
            </div>
...
export default {
  ...
  mounted() {
    ...
    const socket = new WebSocket(`wss://stream.binance.com:9443/ws/${this.coin.toLowerCase()}usdt@ticker`);
