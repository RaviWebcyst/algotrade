       ...
       <div class="content-wrapper content-wrapper2">
           <section class="content mt-5">
               <div class="container">
                   <div class="card">
                       <div class="card-body">
                           <h4 class="my-3"><a href="javascript:;" @click="$router.go(-1)"><i class="fas fa-arrow-left pr-3"></i></a> Level Incomes</h4>
                           <div class="table-responsive">
                               ...
                               <pagination v-model="page" :records="records" @paginate="level_incomes" />
                           </div>
                       </div>
                   </div>
               </div>
