                ...
                <main class="flex-shrink-0 main-content">
                    <div class="header-main row align-items-center p-4 sticky-top m-0">
                        ...
                        <div class="col text-center">
                            <div class="text-center text-white fw-medium">Compound Incomes</div>
                        </div>
                        <div class="col-2"></div>
                    </div>
                    <div class="mx-3 mt-3">
                        <div class="table-responsive">
                            ...
                            <pagination v-model="page" :records="records" @paginate="income_history" :per-page="per_page" />
...
export default {
   ...
   methods: {
       ...
       income_history(){
           axios.post(this.url+"api/income_history",{
