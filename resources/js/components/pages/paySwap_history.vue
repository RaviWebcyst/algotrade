                ...
                <main class="flex-shrink-0 main-content">
                    <div class="header-main row align-items-center p-4 sticky-top m-0">
                        ...
                        <div class="col text-center">
                            <div class="text-center text-white fw-medium">Swap History</div>
                        </div>
                        <div class="col-2"></div>
                    </div>
                    <div class="mx-3 mt-3">
                        <div class="table-responsive">
                            ...
                            <pagination v-model="page" :records="records" @paginate="swaps" :per-page="per_page" />
       ...
       <div class="content-wrapper content-wrapper2">
           <section class="content mt-5">
               <div class="container">
                   <div class="card">
                       <div class="card-body">
                           <h4 class="my-3"><a href="javascript:;" @click="$router.go(-1)"><i class="fas fa-arrow-left pr-3"></i></a> Payout Swap History</h4>
                           <div class="table-responsive">
...
export default {
  ...
  methods: {
      ...
      swaps(){
          axios.post(this.url+"api/paySwap_history?page="+this.page,{
